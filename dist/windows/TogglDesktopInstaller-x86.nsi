...
!else
  ...
  !system 'echo "C:\Program^ Files^ ^(x86^)\Windows^ Kits\10\Tools\bin\i386\signtool.exe sign -a -t http://timestamp.verisign.com/scripts/timestamp.dll -f Certificate.pfx $%TEMP%\Uninstall.exe"' = 0
