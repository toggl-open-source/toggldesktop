...
!else
  ...
  !system '"C:\Program Files (x86)\Windows Kits\10\Tools\bin\10.0.18362.0\x64\signtool.exe" sign -a -t "http://timestamp.verisign.com/scripts/timestamp.dll" -f "Certificate.pfx" "$%TEMP%\Uninstall.exe"' = 0
