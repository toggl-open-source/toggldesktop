...
HelpDatabase::HelpDatabase() {
    ...
    articles_.push_back(  // NOLINT
        HelpArticle(
            "post",  // NOLINT
            "Toggl Track for Windows",  // NOLINT
            "https://support.toggl.com/toggl-track-for-windows",  // NOLINT
            "toggl track for windows"));  // NOLINT
    // NOLINT
    articles_.push_back(  // NOLINT
        HelpArticle(
            "post",  // NOLINT
            "Toggl Track for Mac",  // NOLINT
            "https://support.toggl.com/toggl-track-for-mac-osx",  // NOLINT
            "toggl track for mac"));  // NOLINT
    // NOLINT
    articles_.push_back(  // NOLINT
        HelpArticle(
            "post",  // NOLINT
            "Toggl Track for Linux",  // NOLINT
            "https://support.toggl.com/toggl-track-for-linux",  // NOLINT
            "toggl track for linux"));  // NOLINT
    // NOLINT
    articles_.push_back(  // NOLINT
        HelpArticle(
            "post",  // NOLINT
            "Clearing the local data from Toggl Track",  // NOLINT
            "https://support.toggl.com/clearing-the-local-data-from-toggl-track",  // NOLINT
            "clearing the local data from toggl track"));  // NOLINT
    // NOLINT
    articles_.push_back(  // NOLINT
        HelpArticle(
