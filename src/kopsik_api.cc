...
void kopsik_settings_clear(KopsikSettings *settings) {
...
kopsik_api_result kopsik_sync(
  ...
  kopsik::ExplicitScopedLock("kopsik_sync", ctx->mutex);
...
kopsik_api_result kopsik_push(
  ...
  kopsik::ExplicitScopedLock("kopsik_push", ctx->mutex);
...
kopsik_api_result kopsik_set_time_entry_end_iso_8601(
  ...
  kopsik::ExplicitScopedLock("kopsik_set_time_entry_end_iso_8601", ctx->mutex);
...
kopsik_api_result kopsik_split_running_time_entry_at(
  ...
  kopsik::ExplicitScopedLock("kopsik_split_running_time_entry_at", ctx->mutex);
