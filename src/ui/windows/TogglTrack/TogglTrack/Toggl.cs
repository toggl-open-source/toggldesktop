...
public static partial class Toggl
{
    ...
    public static readonly string WritableAppDirPath =
        Path.Combine(
            ...
            Environment.SpecialFolder.LocalApplicationData), "TogglTrack");
    ...
    public static void InitialiseLog()
    {
        ...
        if (null == LogPath)
        {
            LogPath = Path.Combine(path, "toggltrack.log");
        }
    ...
    public static bool StartUI(string version)
    {
        ...
        {
            DatabasePath = Path.Combine(path, "toggltrack.db");
        }
    ...
    private static void DeleteOldUpdates()
    {
        ...
        foreach (var file in di.GetFiles("TogglTrackInstaller*.exe", SearchOption.TopDirectoryOnly))
        {
            try
            {
        ...
        var updatesDir = new DirectoryInfo(
            Path.Combine(
                Environment.GetFolderPath(
                    Environment.SpecialFolder.LocalApplicationData), "Onova", "TogglTrack"));
