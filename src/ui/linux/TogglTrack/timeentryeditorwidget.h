...
#ifndef SRC_UI_LINUX_TOGGLTRACK_TIMEENTRYEDITORWIDGET_H_
#define SRC_UI_LINUX_TOGGLTRACK_TIMEENTRYEDITORWIDGET_H_
...
#endif  // SRC_UI_LINUX_TOGGLTRACK_TIMEENTRYEDITORWIDGET_H_
