...
#ifndef SRC_UI_LINUX_TOGGLTRACK_PREFERENCESDIALOG_H_
#define SRC_UI_LINUX_TOGGLTRACK_PREFERENCESDIALOG_H_
...
#endif  // SRC_UI_LINUX_TOGGLTRACK_PREFERENCESDIALOG_H_
