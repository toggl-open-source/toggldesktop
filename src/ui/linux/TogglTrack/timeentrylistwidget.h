...
#ifndef SRC_UI_LINUX_TOGGLTRACK_TIMEENTRYLISTWIDGET_H_
#define SRC_UI_LINUX_TOGGLTRACK_TIMEENTRYLISTWIDGET_H_
...
#endif  // SRC_UI_LINUX_TOGGLTRACK_TIMEENTRYLISTWIDGET_H_
