...
#ifndef SRC_UI_LINUX_TOGGLTRACK_IDLENOTIFICATIONWIDGET_H_
#define SRC_UI_LINUX_TOGGLTRACK_IDLENOTIFICATIONWIDGET_H_
...
#endif  // SRC_UI_LINUX_TOGGLTRACK_IDLENOTIFICATIONWIDGET_H_
