...
#ifndef SRC_UI_LINUX_TOGGLTRACK_ERRORVIEWCONTROLLER_H_
#define SRC_UI_LINUX_TOGGLTRACK_ERRORVIEWCONTROLLER_H_
...
#endif  // SRC_UI_LINUX_TOGGLTRACK_ERRORVIEWCONTROLLER_H_
