// Copyright 2018 Toggl Track developers.
...
uint SystemTray::requestNotification(uint previous, const QString &title, const QString &description) {
    ...
    if (notificationsPresent) {
        QByteArray data;
        QImage im(":/icons/64x64/toggltrack.png");
    ...
    // fallback for other platforms
        ...
        showMessage(title, description, QIcon(":/icons/64x64/toggltrack.png"));
        return 0;
    }
}
