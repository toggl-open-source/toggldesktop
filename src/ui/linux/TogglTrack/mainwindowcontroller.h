...
#ifndef SRC_UI_LINUX_TOGGLTRACK_MAINWINDOWCONTROLLER_H_
#define SRC_UI_LINUX_TOGGLTRACK_MAINWINDOWCONTROLLER_H_
...
#endif  // SRC_UI_LINUX_TOGGLTRACK_MAINWINDOWCONTROLLER_H_
