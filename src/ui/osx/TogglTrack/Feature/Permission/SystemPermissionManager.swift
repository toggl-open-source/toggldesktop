...
extension SystemPermissionManager {
    ...
    private func presentScreenRecordingAlert(_ complete: () -> Void) {
        ...
        alert.informativeText = "To get the focused application window name properly for the Timeline, TogglTrack needs to be granted the Screen Recording permission in Security & Privacy in System Preferences .\n\nPlease open System Preferences -> Security & Privacy -> Privacy Tab -> Select Screen Recording and enable TogglTrack app."
