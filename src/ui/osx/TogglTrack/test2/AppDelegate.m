...
{
	[[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"http://toggl.github.io/toggltrack"]];
}
...
- (id)init
{
	...
	self.db_path = [self.app_path stringByAppendingPathComponent:@"toggltrack.db"];
