...
#import "TogglTrack-Swift.h"
#import "DesktopLibraryBridge.h"

NSString *const kPreferenceGlobalShortcutShowHide = @"TogglTrackGlobalShortcutShowHide";
NSString *const kPreferenceGlobalShortcutStartStop = @"TogglTrackGlobalShortcutStartStop";
