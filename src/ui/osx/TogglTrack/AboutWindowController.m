...
static NSString *const kTogglTrackGithubURL = @"https://github.com/toggl-open-source/toggltrack";
...
- (void)textFieldClicked:(id)sender
{
	...
	{
		[[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:kTogglTrackGithubURL]];
		return;
	}
}
