...
{
	NSString *location = @"Library/Application Support/TogglTrack/.Sparkle";
...
{
#ifdef SPARKLE
	NSString *url = [NSString stringWithFormat:@"https://toggl-open-source.github.io/toggltrack/assets/releases/darwin_%@_appcast.xml", channel];
