...
Poco::Logger &UpdateUI::logger() const {
    return Poco::Logger::get("context");
}

void UpdateUI::update(const UIElements &what, User *user) {
...
void UpdateUI::renderTimeEntryEditor(User *user, const UIElements &what) {
...
void UpdateUI::renderWorkspaceSelect(User *user) {
...
void UpdateUI::renderClientSelect(User *user) {
...
void UpdateUI::renderTimerState(User *user) {
...
void UpdateUI::renderTimeEntries(User *user, const UIElements &what) {
...
void UpdateUI::renderSettings(User *user, const UIElements &what, Settings *settings) {
...
error UpdateUI::ToggleEntriesGroup(std::string name) {
    entry_groups[name] = !entry_groups[name];
    OpenTimeEntryList();
    return noError;
}

void UpdateUI::OpenTimeEntryList() {
...
void UpdateUI::ResetAutotrackerView() {
