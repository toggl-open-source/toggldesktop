...
func main() {
	...
	write("// Copyright 2016 Toggl Track developers.")
	write("")
	write("using System;")
	write("using System.Runtime.InteropServices;")
	write("")
	write("namespace TogglTrack")
	write("{")
	write("    public static partial class Toggl")
	write("    {")
	write("    		private const string dll = \"TogglTrackDLL.dll\";")
	...
	err = ioutil.WriteFile("src/ui/windows/TogglTrack/TogglTrack/TogglApi.cs", b, 0644)
	if err != nil {
		println(err.Error())
		os.Exit(1)
	}
