    ...
    for (var ka in os) {
      ...
      for (var kb in cur.filename) {
        ...
        tmp = "<tr>" +
          ...
          "<td>" + ka + "</td>" +
          "<td sorttable_customkey='" + cur.version.split(".").join("") + "'><a target='_blank' href='https://github.com/toggl-open-source/toggldesktop/releases/download/v" + 
        cur.version + "/" + cur.filename[kb].name + "' title='" + cur.timestamp + "'>" + cur.version + "</a></td>" +
          ...
          "<td sorttable_customkey='" + prev.version.split(".").join("") + "'><a target='_blank' href='https://github.com/toggl-open-source/toggldesktop/releases/download/v" + 
